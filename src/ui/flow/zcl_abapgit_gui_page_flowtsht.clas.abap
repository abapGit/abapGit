CLASS zcl_abapgit_gui_page_flowtsht DEFINITION
  ...
  PRIVATE SECTION.
    ...
    TYPES ty_unsupported_tt TYPE SORTED TABLE OF ty_unsupported WITH UNIQUE KEY obj_type.
...
CLASS zcl_abapgit_gui_page_flowtsht IMPLEMENTATION.
  ...
  METHOD zif_abapgit_gui_renderable~render.
    ...
    ri_html->add( |<h2>Unsupported Object Types Per Flow-Enabled Repository</h2>| ).
      ...
      LOOP AT lt_repos INTO li_repo_online.
        ...
        LOOP AT lt_tadir ASSIGNING <ls_tadir>.
          ...
          ELSE.
            ...
            INSERT ls_unsupported INTO TABLE lt_unsupported.
          ENDIF.
        ENDLOOP.

        ri_html->add( |<h3>{ li_repo->get_name( ) }</h3>| ).
        ri_html->add( |<table>| ).
