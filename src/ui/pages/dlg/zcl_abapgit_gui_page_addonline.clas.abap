...
CLASS zcl_abapgit_gui_page_addonline IMPLEMENTATION.
  ...
  METHOD zif_abapgit_gui_event_handler~on_event.
    ...
    DATA: ls_repo_params     TYPE zif_abapgit_services_repo=>ty_repo_params,
          li_new_online_repo TYPE REF TO zif_abapgit_repo.
    ...
    CASE ii_event->mv_action.
      ...
      WHEN c_event-add_online_repo.
        ...
        IF mo_validation_log->is_empty( ) = abap_true.
          ...
          li_new_online_repo = zcl_abapgit_services_repo=>new_online( ls_repo_params ).
          rs_handled-page  = zcl_abapgit_gui_page_repo_view=>create( li_new_online_repo->get_key( ) ).
