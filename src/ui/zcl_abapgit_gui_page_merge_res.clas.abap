CLASS zcl_abapgit_gui_page_merge_res DEFINITION
  ...
  PRIVATE SECTION.
    ...
    DATA mt_conflicts TYPE zcl_abapgit_merge=>ty_merge_conflict_tt .
...
CLASS ZCL_ABAPGIT_GUI_PAGE_MERGE_RES IMPLEMENTATION.
  ...
  METHOD apply_merged_content.
    ...
    FIELD-SYMBOLS:
      <ls_conflict> TYPE zcl_abapgit_merge=>ty_merge_conflict.
  ...
  METHOD render_diff.
    ...
    FIELD-SYMBOLS: <ls_conflict> TYPE zcl_abapgit_merge=>ty_merge_conflict.
