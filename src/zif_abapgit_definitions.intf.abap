INTERFACE zif_abapgit_definitions
  ...
  TYPES: ty_bitbyte TYPE c LENGTH 8 .
  ...
  TYPES: ty_rsvbfidesc_tt TYPE STANDARD TABLE OF rsvbfidesc WITH DEFAULT KEY .
  ...
  TYPES: BEGIN OF ty_git_tag,
           ...
           body         TYPE string,
         END OF ty_git_tag .
  TYPES: ty_git_tag_list_tt TYPE STANDARD TABLE OF ty_git_tag WITH DEFAULT KEY .
  TYPES: BEGIN OF ty_hotkey,
           action TYPE string,
           hotkey TYPE string,
         END OF ty_hotkey .
  TYPES: tty_hotkey TYPE STANDARD TABLE OF ty_hotkey
                    WITH NON-UNIQUE DEFAULT KEY
                    WITH NON-UNIQUE SORTED KEY action
                         COMPONENTS action.
  TYPES: BEGIN OF ty_git_user,
           name  TYPE string,
           email TYPE string,
         END OF ty_git_user .
  ...
  TYPES: BEGIN OF ty_item,
         ...
         END OF ty_item .
  TYPES: ty_items_tt TYPE STANDARD TABLE OF ty_item WITH DEFAULT KEY .
  TYPES: ty_items_ts TYPE SORTED TABLE OF ty_item WITH UNIQUE KEY obj_type obj_name .
  ...
  TYPES: BEGIN OF ty_delete_checks,
           transport TYPE ty_transport,
  ...
  TYPES: ty_results_ts_path TYPE HASHED TABLE OF ty_result WITH UNIQUE KEY path filename .
  ...
  TYPES: BEGIN OF ty_obj_attribute,
           cmpname   TYPE seocmpname,
           attkeyfld TYPE seokeyfld,
           attbusobj TYPE seobusobj,
         END OF ty_obj_attribute .
  TYPES: ty_obj_attribute_tt TYPE STANDARD TABLE OF ty_obj_attribute WITH DEFAULT KEY
                             WITH NON-UNIQUE SORTED KEY cmpname COMPONENTS cmpname .
  TYPES: BEGIN OF ty_transport_to_branch,
  ...
  TYPES: tt_merge_conflict TYPE STANDARD TABLE OF ty_merge_conflict WITH DEFAULT KEY .
  ...
  TYPES: tty_dokil TYPE STANDARD TABLE OF dokil
                         WITH NON-UNIQUE DEFAULT KEY .
  TYPES: tty_lines TYPE STANDARD TABLE OF i
                        WITH NON-UNIQUE DEFAULT KEY .
  TYPES: BEGIN OF ty_col_spec,
  ...
  CONSTANTS: BEGIN OF c_git_branch_type,
  ...
  CONSTANTS: BEGIN OF c_type,
             ...
             END OF c_type .
  CONSTANTS: BEGIN OF c_state, " https://git-scm.com/docs/git-status
