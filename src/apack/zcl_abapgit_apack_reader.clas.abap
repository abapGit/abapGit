...
CLASS zcl_abapgit_apack_reader IMPLEMENTATION.
  ...
  METHOD format_version.
    ...
    ms_cached_descriptor-sem_version = zcl_abapgit_apack_helper=>conv_str_to_version( ms_cached_descriptor-version ).

    LOOP AT ms_cached_descriptor-dependencies ASSIGNING <ls_dependency>.
      <ls_dependency>-sem_version = zcl_abapgit_apack_helper=>conv_str_to_version( <ls_dependency>-version ).
    ENDLOOP.
