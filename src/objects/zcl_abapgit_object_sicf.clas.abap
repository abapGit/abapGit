CLASS zcl_abapgit_object_sicf DEFINITION PUBLIC INHERITING FROM zcl_abapgit_objects_super FINAL.
...
CLASS zcl_abapgit_object_sicf IMPLEMENTATION.
  ...
  METHOD zif_abapgit_object~exists.
    ...
    ls_tadir = zcl_abapgit_tadir=>read_single_sicf( ms_item-obj_name ).
  ...
  METHOD read.
    ...
    ls_key = zcl_abapgit_tadir=>read_single_sicf( ms_item-obj_name )-obj_name.
