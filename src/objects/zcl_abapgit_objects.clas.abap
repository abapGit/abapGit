CLASS zcl_abapgit_objects DEFINITION PUBLIC FINAL.
...
ENDCLASS.                    "zcl_abapgit_object DEFINITION
...
CLASS zcl_abapgit_objects IMPLEMENTATION.
  ...
  METHOD warning_package.
    ...
    ls_tadir = zcl_abapgit_tadir=>read_single( iv_object   = is_item-obj_type
...
*      lv_class_name = 'ZCL_ABAPGIT_OBJECT_CLAS_NEW'.
*    ENDIF.
  ...
  METHOD supported_list.
    ...
    DELETE lt_snode WHERE type <> 'OPL'
      OR name NP 'ZCL_ABAPGIT_OBJECT_++++'.
...
* ignore all errors and assume the object exists
  ...
  METHOD jump.
    ...
    IF lv_adt_jump_enabled = abap_true.
      TRY.
          zcl_abapgit_objects_super=>jump_adt( i_obj_name = is_item-obj_name
