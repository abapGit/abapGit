...
* In the context of abapGit, the package is known.
  ...
  METHOD DESERIALIZE_LONG_TEXTS.
    ...
    LOOP AT LT_UDMO_LONG_TEXTS INTO LS_UDMO_LONG_TEXT.
      ...
      SELECT MAX( DOKVERSION ) INTO LS_UDMO_LONG_TEXT-HEADER-TDVERSION
      FROM DOKHL
  ...
  METHOD DESERIALIZE_MODEL.
    ...
    " See SDU_MODEL_PUT
    GET TIME.
    MOVE SY-UNAME TO LS_DM40L-FSTUSER.
    MOVE SY-DATUM TO LS_DM40L-FSTDATE.
    MOVE SY-UZEIT TO LS_DM40L-FSTTIME.

    MOVE 'X' TO LS_DM40L-FLG_FRAME.
    MOVE SY-UNAME TO LS_DM40L-LSTUSER.
    MOVE SY-DATUM TO LS_DM40L-LSTDATE.
    MOVE SY-UZEIT TO LS_DM40L-LSTTIME.
    ...
    LOOP AT LT_UDMO_TEXTS INTO LS_UDMO_TEXT.
      ...
      IF SY-SUBRC EQ 0.
        ...
        IF LS_DM40T-LANGBEZ NE LS_UDMO_TEXT-LANGBEZ.
          ...
          MOVE LS_UDMO_TEXT-LANGBEZ  TO LS_DM40T-LANGBEZ.

          MOVE SY-UNAME TO LS_DM40T-LSTUSER.
          MOVE SY-DATUM TO LS_DM40T-LSTDATE.
          MOVE SY-UZEIT TO LS_DM40T-LSTTIME.

          MODIFY DM40T FROM LS_DM40T.

        ENDIF.
      ELSE.
        " There is no active description in this language
        MOVE LS_UDMO_TEXT-LANGBEZ  TO LS_DM40T-LANGBEZ.
        MOVE LS_UDMO_TEXT-SPRACHE  TO LS_DM40T-SPRACHE.
        MOVE LS_UDMO_TEXT-AS4LOCAL TO LS_DM40T-AS4LOCAL.
        MOVE LS_UDMO_TEXT-DMOID    TO LS_DM40T-DMOID.
  ...
  METHOD SERIALIZE_ENTITIES.
    ...
    LOOP AT LT_UDMO_ENTITIES ASSIGNING FIELD-SYMBOL(<UDMO_ENTITY>).
