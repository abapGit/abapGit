...
CLASS zcl_abapgit_object_sajc IMPLEMENTATION.
  ...
  METHOD zif_abapgit_object~changed_by.
    ...
    SELECT crea_user_acct lst_ch_user_acct INTO (lv_created, lv_changed) FROM ('APJ_W_JCE_ROOT')
  ...
  METHOD zif_abapgit_object~is_locked.
    ...
    rv_is_locked = exists_a_lock_entry_for( iv_lock_object = 'APJ_W_JCE_ROOT'
