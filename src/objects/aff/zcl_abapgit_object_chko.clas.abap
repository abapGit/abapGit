...
CLASS ZCL_ABAPGIT_OBJECT_CHKO IMPLEMENTATION.
  ...
  METHOD zif_abapgit_object~delete.
    ...
    DATA: lr_intf_aff_obj    TYPE REF TO data,
          ...
          lo_object_chko     TYPE REF TO object,
          lv_name            TYPE c LENGTH 30,
          lx_error           TYPE REF TO cx_root.
    ...
    TRY.
        ...
        CREATE OBJECT lo_object_chko TYPE ('CL_AFF_OBJ')
           EXPORTING
        ...
        <lg_intf_aff_obj> ?= lo_object_chko.
  ...
  METHOD zif_abapgit_object~deserialize.
    ...
    DATA: lr_chko                 TYPE REF TO data,
          lr_intf_aff_obj         TYPE REF TO data,
          ...
          lo_object_handler       TYPE REF TO object,
          lo_object_chko          TYPE REF TO object,
          lo_chko_json_file       TYPE REF TO object,
    ...
    TRY.
        ...
        CREATE OBJECT lo_chko_json_file TYPE ('CL_AFF_FILE')
          EXPORTING
        ...
        <lg_intf_aff_file> ?= lo_chko_json_file.
    ...
    TRY.
        ...
        CALL METHOD lo_files_container->('IF_AFF_FILES_CONTAINER~GET_FILE')
          EXPORTING
            name   = |{ to_lower( lv_name ) }.{ to_lower( ms_item-obj_type ) }.json|
          RECEIVING
            result = lo_chko_json_file.

        CALL METHOD lo_chko_json_file->('IF_AFF_FILE~GET_CONTENT')
          RECEIVING
